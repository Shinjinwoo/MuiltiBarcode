...
+ (void)addRectangle:(CGRect)rectangle toView:(UIView *)view color:(UIColor *)color {
    ...
    borderLayer.fillColor = [UIColor clearColor].CGColor; //투명
    borderLayer.lineWidth = 2;  // 보더라인 굵기
    borderLayer.borderColor = [UIColor yellowColor].CGColor;

    UIBezierPath *path = [UIBezierPath bezierPathWithRoundedRect:rectangleView.bounds cornerRadius:0];
